...
object ThemeUtils {
    ...
    fun getTheme(activity: Context): Int {
        val sharedPreferences: SharedPreferences = activity.getSharedPreferences(
            Constants.SHARE_PREF.sharedPrefFile,
            Context.MODE_PRIVATE
        )
    ...
    fun getColor(activity: Context): String {
        val sharedPreferences: SharedPreferences = activity.getSharedPreferences(
            Constants.SHARE_PREF.sharedPrefFile,
            Context.MODE_PRIVATE
        )
    ...
    fun getColorKeyboard(activity: Context): String {
        val sharedPreferences: SharedPreferences = activity.getSharedPreferences(
            Constants.SHARE_PREF.sharedPrefFile,
            Context.MODE_PRIVATE
        )
    ...
    fun saveBackground(path: String, activity: Context) {
        val sharedPreferences: SharedPreferences = activity.getSharedPreferences(
    ...
    fun getBackground(activity: Context): String {
        val sharedPreferences: SharedPreferences = activity.getSharedPreferences(
            Constants.SHARE_PREF.backgroundImage,
            Context.MODE_PRIVATE
        )
